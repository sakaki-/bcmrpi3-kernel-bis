...
:--- | ---: | ---:
Kernel, dtbs and modules | 4.14.97.20190205 | [bcmrpi3-kernel-bis-4.14.97.20190205.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/4.14.97.20190205/bcmrpi3-kernel-bis-4.14.97.20190205.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/4.14.97.20190205/bcmrpi3-kernel-bis-4.14.97.20190205.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-bis-4.14.97.20190205.tar.xz -C /
pi64 ~ # sync && reboot
```
...
```console
pi64 ~ # emaint sync --repo rpi3
pi64 ~ # emerge -av =bcmrpi3-kernel-bis-bin-4.14.97.20190205
pi64 ~ # reboot
```
