...
:--- | ---: | ---:
Kernel, dtbs and modules | 5.4.65.20200922 | [bcmrpi3-kernel-bis-5.4.65.20200922.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/5.4.65.20200922/bcmrpi3-kernel-bis-5.4.65.20200922.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/5.4.65.20200922/bcmrpi3-kernel-bis-5.4.65.20200922.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-bis-5.4.65.20200922.tar.xz -C /
pi64 ~ # sync && reboot
```
...
```console
pi64 ~ # emaint sync --repo rpi3
pi64 ~ # emerge -av =bcmrpi3-kernel-bis-bin-5.4.65.20200922
pi64 ~ # reboot
```
