...
* `/boot/bcm-2710-rpi-3-b.dtb`, `/boot/bcm-2710-rpi-3-b-plus.dtb` and `/boot/bcm-2837-rpi-3-b.dtb` (and, from `4.19.25.20190226` onwards, `bcm2710-rpi-cm3.dtb`) (the device tree blobs);
* `/boot/overlays/...` (the device tree blob overlays) (from `4.19.25.20190226`);
...
:--- | ---: | ---:
Kernel, dtbs and modules | 4.19.25.20190226 | [bcmrpi3-kernel-bis-4.19.25.20190226.tar.xz](https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/4.19.25.20190226/bcmrpi3-kernel-bis-4.19.25.20190226.tar.xz)
...
pi64 ~ # wget -c https://github.com/sakaki-/bcmrpi3-kernel-bis/releases/download/4.19.25.20190226/bcmrpi3-kernel-bis-4.19.25.20190226.tar.xz
pi64 ~ # tar -xJf bcmrpi3-kernel-bis-4.19.25.20190226.tar.xz -C /
pi64 ~ # sync && reboot
```
...
```console
pi64 ~ # emaint sync --repo rpi3
pi64 ~ # emerge -av =bcmrpi3-kernel-bis-bin-4.19.25.20190226
pi64 ~ # reboot
```
